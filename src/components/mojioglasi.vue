  ...
  <div>
    ...
    <div class="container table-bordered">
      ...
      >
        ...
        <td>{{ data.napomena }}</td>
        <td>
          <button type="button" class="btn btn-warning" @click="update(data)">
            Ažuriraj podatke
          </button>
        </td>
        <td>
      ...
      >
        ...
        <div class="offcanvas-body">
          ...
          <div class="p-3 border bg-light">
            <p>Potpis:</p>
            <img id="image1" class="img-thumbnail" :src="pic" /><br />
            <br /><br />
          </div>
          <i>Provjeriti podatke prije zaključavanja!</i><br />

    ...
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
        <div
          ...
          style="
            object-fit: contain;
            background-image: url('https://images.unsplash.com/photo-1490724500206-cd5482e02b9e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80');
          "
        >
              ...
              <div class="card-content">
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="align-self-center">
                      <i
                        class="icon-calendar warning font-large-2 float-left"
                      ></i>
                    </div>
                    <div class="media-body" style="margin-left: 50px">
                      <h3>{{ blagdan }} h</h3>
              ...
              <div class="card-content">
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="align-self-center">
                      <i
                        class="icon-cup success font-large-2"
                        style="float: left"
                      ></i>
                    </div>
                    <div
              ...
              <div class="card-content">
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="align-self-center">
                      <i
                        class="icon-calendar danger font-large-2 float-left"
                      ></i>
                    </div>
                    <div class="media-body" style="margin-left: 50px">
                      <h3>{{ odsutan }} h</h3>
...
export default {
  ...
  computed: {
    suma: function () {
      return (
        parseInt(this.blagdan) +
        parseInt(this.br_sati) +
        parseInt(this.nocni_rad) +
        parseInt(this.prekovremeni)
      );
    },
  },
};
